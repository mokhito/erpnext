...
def get_gl_entries(filters):
    ...
    group_by_statement = ''
    order_by_statement = "order by account_number, posting_date"
    ...
    gl_entries = frappe.db.sql(
        ...
        select
            ...
            remarks, against, is_opening {select_fields}, (SELECT account_number FROM `tabAccount` WHERE name = gl.account) AS account_number
        from `tabGL Entry` gl
