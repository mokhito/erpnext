...
def get_price_list_rate_for(args, item_code):
    ...
    # change the uom to stock uom and refetch only after checking if there
    # is a specific price for this specific uom in the price list
    if not price_list_rate and args.get("uom") != args.get("stock_uom"):
